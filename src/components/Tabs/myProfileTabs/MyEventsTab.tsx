...
// import { setEventsWithInterested } from '../../../features/events/eventsSlice'
...
export default function MyEventsPage() {
  ...
  const { data: userList, isFetching, isSuccess } = useGetEventsListForUserQuery(filters)
  ...
  //   if (!currentUser) navigate(MY_PROFILE.MY_PROFILE_TAB)
  ...
  //   toastId = toast.loading(removingFromInterestedEvents ? 'Adding...' : 'Removing...', {
  //     id: currentEventId
  //   })
  // }
    ...
    <div className="col-12 col-md-12 col-lg-9 col-xl-9 mx-xl-3 px-lg-3 px-md-3 px-2">
      <div className="row">
        <div className="col-12">
          <h2 className="fw-bold m-0 ">My Events</h2>
        </div>
      </div>
      <hr />
      <div className="row">
        ...
        {isSuccess &&
          userList?.data?.results.map((event: any) => (
