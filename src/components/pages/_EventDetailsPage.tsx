  ...
  return (
    <div className="wrapper overflow-hidden bg-lite">
      ...
      <div className="container">
        {loading && <Loader />}
        <div className="row d-flex justify-content-center pt-xl-4 pt-3">
            ...
            <div className="col-12 col-md-11 col-lg-7 col-xl-5 pt-4 px-lg-1">
              <div className="row">
                <div className="col-12 col-md-12 col-lg-12 col-xl-12">
                  <h3 className="fw-bold">{data?.eventName}</h3>
                  <p className="text-base mb-1">{data?.eventBio}</p>
                </div>
                ...
                <div className="col-12 col-md-6 col-lg-6 col-xl-5 my-2">
                  <h4 className="oran_tex fw-bold mt-xl-3 mt-3">Chat with Owner</h4>
                </div>
